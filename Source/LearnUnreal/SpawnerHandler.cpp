...
void ASpawnerHandler::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ASpawnerHandler::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ASpawnerHandler::Look);
	}
	else
	{
...
void ASpawnerHandler::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ASpawnerHandler::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
